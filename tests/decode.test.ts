...
describe('unpacks', () => {
	it('short list via string with null byte', () => {
		expect(erlpack.unpack(Buffer.from(`\u0083k\u0000\u000C${helloWorldBinaryWithNull}`, 'binary'))).toEqual(helloWorldListWithNull);
	});
	...
	it('floats', () => {
		expect(erlpack.unpack(Buffer.from('\u0083c2.50000000000000000000e+00\u0000\u0000\u0000\u0000\u0000', 'binary'))).toBe(2.5);
		expect(erlpack.unpack(Buffer.from('\u0083c5.15121238412343125000e+13\u0000\u0000\u0000\u0000\u0000', 'binary'))).toBe(
	...
	it('small big ints', () => {
		...
		expect(erlpack.unpack(Buffer.from('\u0083n\u0004\u0000\u0001\u0002\u0003\u0004', 'binary'))).toBe(67305985);
		expect(() =>
			erlpack.unpack(Buffer.from('\u0083n\u000A\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000A', 'binary'))
		).toThrow(new Error('Unable to decode big ints larger than 8 bytes'));
	});

	it('big ints', () => {
		expect(
			erlpack.unpack(Buffer.from('\u0083o\u0000\u0000\u0000\u0008\u0001\u0001\u0002\u0003\u0004\u0005\u0006\u0007\u0008', 'binary'), true)
	...
	it('tuples', () => {
		expect(erlpack.unpack(Buffer.from('\u0083h\u0003m\u0000\u0000\u0000\u0006vanisha\u0001a\u0004', 'binary'))).toEqual(['vanish', 1, 4]);
		expect(erlpack.unpack(Buffer.from('\u0083i\u0000\u0000\u0000\u0003m\u0000\u0000\u0000\u0006vanisha\u0001a\u0004', 'binary'))).toEqual([
			'vanish',
			1,
			4
		]);
	...
	it('compressed', () => {
		...
		expect(erlpack.unpack(Buffer.from("\u0083l\u0000\u0000\u0000\u0002a\u0002k\u0000\u0019it's getting hot in here.j", 'binary'))).toEqual(
			expected
		);
		expect(
			erlpack.unpack(
	...
	it('references', () => {
		...
		expect(erlpack.unpack(Buffer.from('\u0083em\u0000\u0000\u0000\u0005Hello\u0000\u0000\u0004\u00DD\u0001', 'binary'))).toEqual(reference);
	...
	it('port', () => {
		...
		expect(erlpack.unpack(Buffer.from('\u0083fm\u0000\u0000\u0000\u0005Hello\u0000\u0000\u0004\u00DD\u0001', 'binary'))).toEqual(port);
	});
	...
	it('pid', () => {
		...
		expect(
			erlpack.unpack(Buffer.from('\u0083gm\u0000\u0000\u0000\u0005Hello\u0000\u0000\u0004\u00DD\u0000\u0001\u00E2\u0040\u0001', 'binary'))
		).toEqual(pid);
	});
	...
	it('export', () => {
		...
		expect(erlpack.unpack(Buffer.from('\u0083qd\u0000\u000Dguild_membersd\u0000\u0006appenda\u0001', 'binary'))).toEqual(exp);
	});
	...
	it('excepts from malformed token', () => {
		...
		expect(() => erlpack.unpack(Buffer.from('\u0083k\u0000', 'binary'))).toThrow(new Error('Reading two bytes passes the end of the buffer.'));
	});
	...
	it('excepts from malformed atom', () => {
		expect(() => erlpack.unpack(Buffer.from('\u0083s\u0009true', 'binary'))).toThrow(new Error('Reading sequence past the end of the buffer.'));
	});
	...
	it('excepts from malformed float', () => {
		expect(() => erlpack.unpack(Buffer.from('\u0083c2.500000000000000e+00\u0000\u0000\u0000\u0000\u0000', 'binary'))).toThrow(
