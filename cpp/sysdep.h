...
#define _erlpack_be32(x) \
    (((((uint32_t)x) << 24)) | ((((uint32_t)x) << 8) & 0x00ff0000U) | ((((uint32_t)x) >> 8) & 0x0000ff00U) | ((((uint32_t)x) >> 24)))
#endif
#else
#define _erlpack_be32(x) ntohl(x)
#endif
...
#define _erlpack_be64(x) \
    (((((uint64_t)x) << 56)) | ((((uint64_t)x) << 40) & 0x00ff000000000000ULL) | ((((uint64_t)x) << 24) & 0x0000ff0000000000ULL) | ((((uint64_t)x) << 8) & 0x000000ff00000000ULL) | ((((uint64_t)x) >> 8) & 0x00000000ff000000ULL) | ((((uint64_t)x) >> 24) & 0x0000000000ff0000ULL) | ((((uint64_t)x) >> 40) & 0x000000000000ff00ULL) | ((((uint64_t)x) >> 56)))
#endif
